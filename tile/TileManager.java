...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        try {
            ...
            tile[6] = new Tile();
            tile[6].image = ImageIO.read(getClass().getResourceAsStream("/res/tiles/lava01.png"));
        ...
        try {
            ...
            while (col < gp.maxWorldCol && row < gp.maxWorldRow) {
                ...
                while (col < gp.maxWorldCol) {
                    String numbers[] = line.split(" ");// splitta la stringa con uno spazio
    ...
    public void draw(Graphics2D g2) {
        ...
        while (worldCol < gp.maxWorldCol && worldRow < gp.maxWorldRow) {
            ...
            int tileNum = mapTileNum[worldCol][worldRow];// array che contiene il tipo di tile

            // poszione sulla mappa
            int worldX = worldCol * gp.tileSize;
            int worldY = worldRow * gp.tileSize;
            // dove disegnare il tile sullo schermo
